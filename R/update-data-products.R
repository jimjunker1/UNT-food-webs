...
update_data_products = function(products = NULL, set_env = FALSE, create_dir = FALSE,...){
  ...
  if(!dir.exists(Sys.getenv("NEONSTORE_HOME")) & create_dir == FALSE)  stop("The database location './ignore/database-files' does not exist. To create it, set `create_dir` = TRUE")
